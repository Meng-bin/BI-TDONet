...
# os.environ["XLA_FLAGS"] = "--xla_gpu_cuda_data_dir=/public/home/jiangy/cuda-11.6"
...
path = "/home/ext8/mengbin/BI-TDONet_datasets/Potential_flow_problem"
data = sio.loadmat(path + "/data.mat")
para1 = data["para"]
phi1 = data["phi"]
f1 = data["f"]

para = np.concatenate([para, para1], axis=0)
f = np.concatenate([f, f1], axis=0)
phi = np.concatenate([phi, phi1], axis=0)
